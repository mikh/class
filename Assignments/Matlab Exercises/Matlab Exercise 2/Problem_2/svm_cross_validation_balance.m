function [ CCR, con_mat, TT, ETT ] = svm_cross_validation( X, Y, N, folds, boxconstraint_exponent_low, boxconstraint_exponent_high, autoscale, kernel_function, TT, ETT )
    ...
    for exponent = boxconstraint_exponent_low:boxconstraint_exponent_high
        ...
        for j = 1:folds
            ...
            svm_classifier = svmtrain(training_set, training_validation_set, 'autoscale', autoscale, 'boxconstraint', (2^exponent), 'kernel_function', kernel_function);
            ...
            con_mat{CCR_index} = con_mat{CCR_index} + confusionmat(testing_validation_set, prediction);
