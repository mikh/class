function [ CCR, TT, ETT ] = mikh_svm_cross_validation_rbf( X, Y, N, folds, boxconstraint_exponent_low, boxconstraint_exponent_high, rbf_exponent_low, rbf_exponent_high, autoscale, kernel_function, TT, ETT )
