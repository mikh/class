...
fprintf('Part f running...\n');

fprintf('Determining new word indicies...\t');
vil = 1:l_V;
for ii = 1:l_S
   index = -1;
   for jj = 1:l_V
...
fprintf('%.0f words in vocabulary\n', l_V);
fprintf('Done.\n');

fprintf('Editing training document words...\t');
...
fprintf('Editing testing document words...\t');
testing_set_words = 0;
for ii = 1:N_test
